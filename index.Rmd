...
#### Statistics Journals
1. Sung, C. -L., Haaland, B. Hwang, Y.  and  Lu, S. Clustered Gaussian process model with an application to solar irradiance emulation. Submitted. [arxiv](https://arxiv.org/abs/1911.04602)
1. Hwang, Y., Lee, E., Cho, D., Zhang, Q. (2019) A Spline-based Multilevel Modeling Approach for Complex Data. Submitted.
1. Zhang, Q. and  Hwang, Y. (2019+). [Sequential Model-based Optimization for Continuous Inputs with Finite Decision Space](https://doi.org/10.1080/00401706.2019.1665589). *Technometrics*. In press.
1. Xu, X., Hwang, Y., Kim, T., Wang, F., Wang, X., Chien, P. (2019+). [Level-expansion: A Statistical Sequential Design Methodology with Application to Nanomaterial Synthesis](https://www.tandfonline.com/doi/full/10.1080/00224065.2019.1571335). *Journal of Quality Technology*. In press.
...
#### Collaborative 
1. Kim, S., Hwang, Y., Seo, H., Kim, B. (2019).
...
Toxicity and physical effects of PVC and ABS microplastics on cells according to shape of microplastics using pattern analysis.  Submitted.
1. Choi, D., Hwang, J., Bang, J., Han, J., Kim, T., Oh, Y., Hwang, Y. Choi, J. and Hong, J.
