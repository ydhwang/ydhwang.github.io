...
1. Sung, C. -L., Haaland, B. Hwang, Y.  and  Lu, S. (2021+) Clustered Gaussian process model with an application to solar irradiance emulation. Submitted. [arxiv](https://arxiv.org/abs/1911.04602)
1. Yang, S., Kim, J. and Hwang, Y. (2021+) Integration of survey data and big observational data for finite population inference using mass imputation. In Press. *Survey Methodology*.
...
[Virus Shook the Streaming Star: Estimating the COVID-19 Impact on Music Consumption](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3649085). *Marketing Science.* Accepted.
1. Choi, W., Park, S., Kwon, J., Jang, E, Kim, J, Heo, J, Hwang, Y., Kim, B., Moon, J., Jung, S., Choi, S., Lee, H., Ahn, H., and Hong, J. (2021+). [Reverse Actuation of Polyelectrolyte Effect for In Vivo Antifouling](https://pubs.acs.org/doi/full/10.1021/acsnano.0c10431). *ACS Nano*. In press.
