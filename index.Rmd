...
1. Hwang, Y., Kim, H., Chang, W., Yeo, K. and Kim, Y. (2019+). [Bayesian Pollution Source Identification via an Inverse Physics Model](https://www.sciencedirect.com/science/article/pii/S0167947318302822).  *Computational Statistics and Data Analysis*, Accepted.
1. Xu, X., Hwang, Y., Kim, K., Wang, F., Wang, X., Chien, P. (2019+). Sequential Synthesis of Nanomaterials via Level-expansion. *Journal of Quality Technology*, Accepted.
1. Yeo, K., Hwang, Y., Liu, X. and Kalagnanam, J. (2019). [Development of a Spectral Source Inverse Model by Using Generalized Polynomial Chaos](https://www.sciencedirect.com/science/article/pii/S0045782518306212?dgcid=author). *Computer Methods in Applied Mechanics and Engineering,* **347**, 1-20.
